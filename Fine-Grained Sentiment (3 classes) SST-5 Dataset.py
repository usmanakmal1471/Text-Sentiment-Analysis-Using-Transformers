# -*- coding: utf-8 -*-
"""Fine-Grained Sentiment (3 classes) SST-5 Dataset.ipynb
...
# **Fine-Grained Sentiment Analysis (3 Classes) SST-5 Dataset**
...
file_path = "/content/drive/MyDrive/SST-5 Dataset (3 Classes).csv"
